...
//
// # go test -benchmem -run=none github.com/gauss-project/eswarm/swarm/storage/localstore -bench BenchmarkRetrievalIndexes -v
// goos: darwin
// goarch: amd64
...
//
// go test -benchmem -run=none github.com/gauss-project/eswarm/swarm/storage/localstore -bench BenchmarkUpload -v
// goos: darwin
// goarch: amd64
// pkg: github.com/gauss-project/eswarm/swarm/storage/localstore
